    ...
    <div className="min-h-screen h-full parent bg-[#E1EFFF] flex flex-col justify-evenly">
      <div className="stuent-n-exam-details">
        <div className="flex flex-row justify-evenly">
          <div className="flex flex-row justify-evenly items-center test-details bg-white w-full mt-2 ml-2 mr-0.5 MCQ_Stats rounded-2xl text-center p-4 text-2xl shadow-[0px_4px_12px_0px_rgba(3,104,255,0.15)]">
            <span className="flex flex-row gap-4 items-center">
              <img src="ExamModule/Exam.png" alt="" /> <span>Daily Test</span>
            </span>
            <span>
