...
`;
    ...
    console.log("Payload to /api/v1/runcode:", payload);
    ...
    try {
      ...
      setOutput(result.stderr || result.compile_output || result.stdout || "No output received.");
        } catch (error) {
...
const handleDownloadFile = () => {
  ...
  return (
    <div style={containerStyle} ref={containerRef}>
      <Splitter>
        <SplitterPanel style={leftPanelStyle}>
      ...
      {/* Right Panel */}
      <Splitter style={rightPanelStyle} className="overflow-y-auto">
        <SplitterPanel>
