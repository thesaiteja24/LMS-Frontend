...
import { FaUserGraduate, FaChalkboardTeacher, FaTasks, FaClipboardList, FaEnvelopeOpenText } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-gray-100">
      ...
      <main className="container mx-auto px-4 py-6">
        <h2 className="text-4xl font-bold text-center text-blue-700 mb-8"> Manager Dashboard</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {location !== 'all' && (
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-semibold text-blue-600">Students Enrollment</h3>
