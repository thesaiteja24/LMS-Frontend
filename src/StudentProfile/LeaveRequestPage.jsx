...
const LeaveRequestPage = () => {
  ...
  return (
    <div className="bg-[#f4f4f4] flex justify-center  p-6">
      <div className="relative w-full max-w-[1420px] min-h-[80vh] bg-white shadow-lg rounded-md p-10 flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10">
          <div className="w-full lg:w-[60%]">
            ...
            <form id="leaveForm" onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 mt-6">
              ...
              form="leaveForm"
                ...
                onChange={handleChange}
                className="w-full md:w-[66%] h-[60px] border border-[#0C1BAA] rounded-md p-4 bg-[#EFF0F7] text-gray-600 resize-none"
                placeholder="reason:......"
                required
              />
              <button 
          ...
          <div className="w-full lg:w-[40%] flex justify-end">
            <img src="/leave/Frame.svg" alt="Leave Request Illustration" className="w-auto max-w-xs md:max-w-md lg:max-w-lg" />
          </div>
        </div>
                  ...
                  currentItems.map((leave, index) => (
                    <tr key={index} className={index % 2 === 0 ? "bg-gray-100" : "bg-white"}>
                      ...
                      <td className="p-3 border">
                        <span className={`px-4 py-1 rounded-md text-white ${leave.status === "accepted" ? "bg-green-500" : "bg-orange-500"}`}>
                          {leave.status}
                        </span>
                      </td>
                    </tr>
