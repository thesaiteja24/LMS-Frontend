...
const Reports = () => {
  ...
  const fetchCounts = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/v1/adminsdata`);
  ...
  return (
    <div className="container mx-auto mt-8 px-4">
      <h2 className="text-5xl font-bold text-center mb-6 text-gray-800">Dashboard</h2>
